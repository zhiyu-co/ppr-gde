...
MODEL_SAVE_DIR=${MODEL_SAVE_DIR:-"$REPO_ROOT/checkpoints/ppo_think"}
DATA_DIR=${DATA_DIR:-"$REPO_ROOT/data/roleplay"}
export LOG_DIR=${LOG_DIR:-"$SCRIPT_DIR/log/ppo_think"}

trainer_project=${trainer_project:-roleplay_ppo_think}
trainer_experiment=${trainer_experiment:-ppo_think}
