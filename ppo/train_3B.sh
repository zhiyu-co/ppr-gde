...
MODEL_SAVE_DIR=${MODEL_SAVE_DIR:-"$REPO_ROOT/checkpoints/ppo_nothink_3B"}
DATA_DIR=${DATA_DIR:-"$REPO_ROOT/data/roleplay"}
export LOG_DIR=${LOG_DIR:-"$SCRIPT_DIR/log/ppo_nothink_3B"}

trainer_project=${trainer_project:-roleplay_ppo_3B_nothink}
