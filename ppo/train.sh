...
MODEL_SAVE_DIR=${MODEL_SAVE_DIR:-"$REPO_ROOT/checkpoints/ppo_nothink_0.6B"}
DATA_DIR=${DATA_DIR:-"$REPO_ROOT/data/roleplay"}
export LOG_DIR=${LOG_DIR:-"$SCRIPT_DIR/log/ppo_nothink_0.6B"}

trainer_project=${trainer_project:-roleplay_ppo_0.6B_nothink}
trainer_experiment=${trainer_experiment:-ppo_nothink}
