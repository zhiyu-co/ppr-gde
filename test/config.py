...
CHAR_API_BASE = _endpoint("CHAR_API_BASE", "CHAR_RM_HOST", "CHAR_RM_PORT", "/score", "8001")
EMBEDDING_API_BASE = _endpoint("EMBEDDING_API_BASE", "EMBEDDING_HOST", "EMBEDDING_PORT", "/encode_batch", "8358")
