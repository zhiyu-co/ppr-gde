        ...
        for epoch in range(self.config.ppo_epochs):
            for batch_idx, data in enumerate(dataloader):
                ...
                for data in micro_batches:
                    ...
                    if not self.config.get('clip_ratio_low') and not self.config.get('clip_ratio_high'):
                        ...
                        pg_loss, pg_clipfrac, ppo_kl, pg_clipfrac_lower = core_algos.dapo_compute_policy_loss(
