...
MODEL_SAVE_DIR=${MODEL_SAVE_DIR:-"$REPO_ROOT/checkpoints/grpo_nothink_0.6B"}
DATA_DIR=${DATA_DIR:-"$REPO_ROOT/data/roleplay"}
export LOG_DIR=${LOG_DIR:-"$SCRIPT_DIR/log/grpo_nothink_0.6B"}

trainer_project=${trainer_project:-roleplay_grpo_0.6B_nothink}
